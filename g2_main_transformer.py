...
from Nets.net_transformer import Feature_Fusion, Distance_Combination_Stage_1
...
class AB3DMOT(object):
    ...
    def update(self, dets_all):
        ...
        #     print(D_module.shape, D_mah.shape)
        #     if K is not None:
        #         print(K.shape)
        # print('\n')
...
def track_nuscenes():
    ...
    parser.add_argument('--output_path', type=str, default='transformer.json',
    ...
    writer = SummaryWriter('runs/val_transformer')
