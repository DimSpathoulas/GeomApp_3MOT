...
def track_nuscenes():
    ...
    parser.add_argument('--output_path', type=str, default='lr01_ep10_costum_crit.json',
    ...
    FF = Feature_Fusion().to(device)
    DCS1 = Distance_Combination_Stage_1().to(device)
    optimizer = torch.optim.Adam(list(FF.parameters()) + list(DCS1.parameters()), lr=0.1)
    ...
    writer = SummaryWriter('runs/lr01_ep10_costum_crit')
