...
def track_nuscenes():
    ...
    writer = SummaryWriter('runs/DIST_COMB')
    ...
    for epoch in range(EPOCHS):
        ...
        for name, param in COMB.named_parameters():
            if param.requires_grad:
                writer.add_histogram(f'COMB_gradients/{name}', param.grad, epoch)
                writer.add_histogram(f'COMB_weights/{name}', param.data, epoch)
