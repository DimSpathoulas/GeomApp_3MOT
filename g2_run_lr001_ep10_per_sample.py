...
def track_nuscenes():
    ...
    parser.add_argument('--output_path', type=str, default='per_sample.json',
    ...
    writer = SummaryWriter('runs/per_sample_costum')

    for epoch in range(EPOCHS):

        total_loss_epc = torch.tensor(0.0).to(device=device)
        ...
        writer.add_scalar('Loss/total', total_loss_epc.item(), epoch)
