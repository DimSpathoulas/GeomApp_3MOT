...
def track_nuscenes():
    ...
    parser.add_argument('--output_path', type=str, default='per_scene_lr001_costum.json',
    ...
    FF = Feature_Fusion().to(device)
    DCS1 = Distance_Combination_Stage_1().to(device)
    optimizer = torch.optim.Adam(list(FF.parameters()) + list(DCS1.parameters()), lr=0.01)
    ...
    writer = SummaryWriter('runs/per_scene_lr001_costum')
    leds = 0
