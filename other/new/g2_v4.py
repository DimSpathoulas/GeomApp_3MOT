...
from older_version.covariance import Covariance
...
def track_nuscenes(match_threshold=11):
    ...
    parser.add_argument('--dets_train', type=str,
                        default="/home/ktsiakas/duth_thesis/mrcnn_proj/tracking_input_sample_val.pkl",
    ...
    for epoch in range(EPOCHS):
        ...
        for sample, sample_data in tqdm(all_results.items()):
            ...
            while current_sample_token != '':
                ...
                ### TRAIN BASED ON THE WHOLE SAMPLE
                ## DEN LEITOYRGEI ETSI - UA EPREPE NA FTIAXNO TENSORS KAI META NA FTIAXNO TO LOSS
                ## ALLA GIA KAPOIO LOGO TREXEI KAI ETSI
            ...
            # EDO KANO TRAIN APO OLO TO SCENE ALLA DEN VGAZEI NOHMA
            # optimizer.zero_grad()

            # total_l.backward(retain_graph=False)
